...
### Description
The CubeIDE generates the I2C module for HAL, while a user doesn't enable the I2C from the CubeIDE Device Configuration tool. 
This "excessive" code generation interferes the program which uses HAL_I2C_MODULE_ENABLED by ifdef conditional compilation. 
